...
export const PHLYNX_INSTANCE_PARAMETERS_COMPONENT_NAME = 'model_parameters'

export const INSTANCE_PARAMETER_COMPONENT_NAMES = new Set(['parameters', PHLYNX_INSTANCE_PARAMETERS_COMPONENT_NAME])
